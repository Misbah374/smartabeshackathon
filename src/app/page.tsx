  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full h-screen flex flex-col items-center justify-center p-8">
        ...
        {/* Footer / CTA Section */}
        <div className="absolute bottom-[18%] flex flex-col items-center gap-6 z-30 w-full max-w-md">
          {/* Starting Soon Text */}
          <div className="footer-element text-[#165a94] font-bold tracking-widest text-lg animate-pulse">
            [ STARTING SOON ]
          </div>
